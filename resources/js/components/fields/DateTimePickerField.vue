<template>
    <div class="w-full">
        ...
        <div class="relative">
            <div 
                :class="['relative px-3 py-2 form-input flex items-center focus-within:shadow-outline', { 'shadow-outline': showDatepicker }]" 
                tabindex="1"
            ...
            >
                <input
                    ...
                    readonly
                    v-model="valueString"
                    class="w-full leading-none cursor-pointer focus:outline-none"
            ...
            >
                ...
                <div class="border border-gray-500 p-2 rounded">
                    <div class="flex justify-center mb-1">
                        <select v-model="showing.month">
                            <option 
                                :value="monthIndex" v-for="(monthName, monthIndex) in monthNames" 
                                :key="monthIndex"
                                class="text-lg font-bold text-gray-800"
                            >{{ monthName }}</option>
                        </select>
                        <input type="number" v-model="showing.year" class="ml-1 w-16 text-lg text-gray-600 font-normal">
                    </div>
                ...
                <div class="flex mt-2">
                    <button class="bg-gray-500 w-full rounded p-1 text-white mr-3" @click.prevent="cancel">
                        Cancelar
                    </button>
                    <button class="bg-green-500 w-full rounded p-1 text-white" @click.prevent="save">
                        Salvar
                    </button>
                </div>
            </div>
